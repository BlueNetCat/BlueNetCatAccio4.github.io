...
const seaVelocityLayer = new ol.layer.Tile({
  ...
  source: new ol.source.TileWMS ({
    ...
    zDirection: -1,
    crossOrigin: 'anonymous',
    params: {'LAYERS': 'uo', 'COLORSCALERANGE':[-1, 1], 'STYLES': 'boxfill/greyscale', 'TRANSPARENT': true}, //'boxfill/occam' or 'boxfill/rainbow'
...
seaVelocityLayer.on('precompose', function(evt) {
...
bathymetryLayer.on('precompose', function(evt) {
        // use opaque background to keep data layers hidden while map is rendering
