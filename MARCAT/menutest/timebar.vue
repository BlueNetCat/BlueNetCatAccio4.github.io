      ...
      <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <div class="container">
              <!-- Row with weather type -->
              <div class="row">
                <!-- Central column with icons -->
                <div class="col">
              ...
              <div class="row align-items-end flex-nowrap">
                <div class="col btn btn-outline-light" :class="[date.active ? 'active border': '']" :id="date.index" @click.prevent="dateClicked" v-for="date in getDates" :key="date.dateName">
                  ...
                  <figure class="figure">
                    ...
                    <vue-load-image>
                      ...
                      <template v-slot:preloader>
                        <img src="/geoportal/img/image-loader.gif" style="max-width: 16em"/>
                      </template>
                    </vue-load-image>
